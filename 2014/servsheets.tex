...
6.        Should the winning bidder or bidders deem other Olin faculty/staff beneficial (including, but not limited to, those whose names rhyme with “Shark Bummerville” or “Green Fang”) strategic poetry will be deployed in an attempt to entice said faculty/staff.
...
\end{tabular}
\newpage
\section*{4.7 Obviously the World's Best Gelato}
Carly Ingrao
\\
Starting Bid: \$2
\newline
...
\end{tabular}
\newpage
\section*{4.8 Bad Day Cookies in your honor}
...
\end{tabular}
\newpage
\section*{4.11 Suite Supper with Super Silly Suities!}
...
\end{tabular}
\newpage
\section*{4.13 Birthday IHOP Trip!}
Shane Skikne, Chani  Martin and Kari Bender
\\
Starting Bid: \$4
\newline
...
\end{tabular}
\newpage
\section*{4.14 Waffles a la Mickey}
Michael Sheets
\\
Starting Bid: \$4
\newline
...
\end{tabular}
\newpage
\section*{4.19 Shopping Trip to Wegman's}
Alison Black
\\
Starting Bid: \$5.00
\newline
...
\end{tabular}
\newpage
\section*{4.20 Trip to Roxy's Gourment Grilled Cheese restaurant}
Alison Black
\\
Starting Bid: \$5.00
\newline
...
\end{tabular}
\newpage
\section*{4.24 Hot Chili Pepper Jelly}
Pickles \& Jams
\\
Starting Bid: \$5
\newline
...
\end{tabular}
\newpage
\section*{4.25 Bonnie's Brownies}
Bonnie Tesch
\\
Starting Bid: \$5
\newline
...
\end{tabular}
\newpage
\section*{4.31 Delicious Chocolate Pie}
Jennifer Anderson
\\
Starting Bid: \$5
\newline
...
\end{tabular}
\newpage
\section*{4.32 1 "batch" of baked goods of your choice!}
Matt Ruehle
\\
Starting Bid: \$6
\newline
...
\end{tabular}
\newpage
\section*{4.33 Homemade Marshmallows}
Katie Peters
\\
Starting Bid: \$6
\newline
...
\end{tabular}
\newpage
\section*{4.34 1 Batch of Chocolate Chip  Cookies}
Becca Gettys
\\
Starting Bid: \$8
\newline
...
\end{tabular}
\newpage
\section*{4.36 Dumplings from Chinatown}
Louis Yi
\\
Starting Bid: \$10
\newline
...
\end{tabular}
\newpage
\section*{4.37 Japanese Care Package}
William Saulnier
\\
Starting Bid: \$10
\newline
...
\end{tabular}
\newpage
\section*{4.38 Subhash's Popcorn}
Geeta Gubba
\\
Starting Bid: \$10
\newline
...
\end{tabular}
\newpage
\section*{4.39 Parcel Bees honey (1 lb.)}
Ben Linder
\\
Starting Bid: \$10
\newline
...
\end{tabular}
\newpage
\section*{4.46 Toscanini's ice cream sundaes}
Diana Dabby
\\
Starting Bid: \$10
\newline
...
\end{tabular}
\newpage
\section*{4.47 Cheesecake Double Date}
Ari and Derek
\\
Starting Bid: \$10
\newline
...
\end{tabular}
\newpage
\section*{4.49 A case of Girl Scout Thin Mints}
Stephen Brand
\\
Starting Bid: \$15
\newline
...
\end{tabular}
\newpage
\section*{4.50 Chocolate-covered peanut butter balls}
Maruta Vitols
\\
Starting Bid: \$20
\newline
...
\end{tabular}
\newpage
\section*{4.51 Fondue Fest for Four}
Graham Hooton
\\
Starting Bid: \$20
\newline
...
\end{tabular}
\newpage
\section*{4.52 Sushi Lunch w/Marketing \& Communication}
Alyson Goodrow
\\
Starting Bid: \$20
\newline
...
\end{tabular}
\newpage
\section*{4.53 Kitchen Adventure}
James Nee
\\
Starting Bid: \$25
\newline
...
\end{tabular}
\newpage
\section*{4.55 Pizza-making at my house}
Aaron Hoover
\\
Starting Bid: \$50
\newline
...
service\_time = 60 \# minutes, i.e. an hour-long lunch meeting with Emily, Mike, and Ryan (EMR)
while SERV\_auction\_over == False:
    service\_time += len(name of the previous bidder)
\\[6ex]
\begin{tabular}{c c c}
~~~~~~~~~~~~~Name~~~~~~~~~~~~~ & ~~~~~~~~~Bid (\$)~~~~~~~~~  & ~~~Email Address (if not standard olin.edu)~~~\\
 & & \\
...
\end{tabular}
\newpage
\section*{6.85 Custom Built Electric Guitar}
Sean Karagianes
\\
Starting Bid: \$100
\newline
